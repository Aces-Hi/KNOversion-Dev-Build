-- Define an array of possible text options
local footerTextOptions = {
  "Now playing Fatal Art Reload.",
  "Now playing Blazing Strike.",
  "Now playing Kirby Battle Blitz.",
  "Now playing Battle Craze.",
  "Now playing Cross Destinies.",
  "Now playing... MOONATICS!",
  "Now playing Stickfigurez.",
  "Now playing YOMI Hustle.",
  "Now playing Archetype False.",
  "Now playing Node Breaker.",
  "Now playing 2XKO.",
  "Not playing Project:NO.",
...
local loadingTextOptions = {
  ...
  "Vitriol... Coalescing....",
  "these lazy devs are killing KO...",
  "Shoutouts to j4rms31!",
  "Shoutouts to PXN!",
  "fatal art isnt dead yet...",
  "MUGEN rehash stick fighter gruel!",
  "KO 2 is real, guys! Trust me!"
}
-- Generate a random index to select a text option
local randomIndexFooter = math.random(1, #footerTextOptions)
local randomIndexLoading = math.random(1, #loadingTextOptions)
--;===========================================================
--; DEFAULT VALUES
--;===========================================================
...
title_info =
{
    ...
    fadein_anim = -1, --Ikemen feature
		...
		loading_offset = {main.SP_Localcoord[1] - 1 - main.f_round(120 * main.SP_Localcoord[1] / 320), main.SP_Localcoord[2] - 100}, --Ikemen feature
		loading_font = {'default-3x5.def', 0, -1, 191, 191, 191, -1}, --Ikemen feature
		loading_scale = {1.0, 1.0}, --Ikemen feature
		loading_text = 'Team:NO presents...', --Ikemen feature
		...
		footer1_text = loadingTextOptions[randomIndexLoading],
		...
		footer2_text = verInfo, --Ikemen feature
	...
	infobox_text = "You're not supposed to be here.",
	...
	select_info =
	{
		...
		title_versus_text = 'KNOCKOUT!', --Ikemen feature
		...
		title_netplayversus_text = 'KNOCKOUT!', --Ikemen feature
		...
		title_training_text = 'THE LAB', --Ikemen feature
		...
		--title_replay_text = 'REPLAYS', --Ikemen feature
		p1_face_pos = {0, 0},
	...
	replay_info =
	{
		...
		title_font = {'f-6x9.def', 0, 0, 255, 255, 255, -1}, --Ikemen feature
		title_scale = {1.0, 1.0}, --Ikemen feature
		title_text = 'REPLAYS', --Ikemen feature
		menu_uselocalcoord = 0, --Ikemen feature
		menu_pos = {85, 33}, --Ikemen feature
		--menu_bg_<itemname>_anim = -1, --Ikemen feature
		--menu_bg_<itemname>_spr = {}, --Ikemen feature
	...
	menu_info =
	{
		...
		movelist_pos = {10, 15}, --Ikemen feature
	...
	training_info =
	{
		...
		menu_valuename_guardmode_pushblock = "Force Block", --Ikemen feature
		menu_valuename_guardmode_recoil = "Recoil Guard", --Ikemen feature
		menu_valuename_guardmode_burst = "Burst", --Ikemen feature
		...
		menu_valuename_fallrecovery_up = "Up", --PXN feature
		menu_valuename_fallrecovery_upback = "Up Back", --PXN feature
		menu_valuename_fallrecovery_upfwd = "Up Forward", --PXN feature
		...
		menu_valuename_punish_off = "Off",
		menu_valuename_punish_on = "Light",
		menu_valuename_punish_reversal = "Reversal",
		menu_valuename_punish_super = "Super 1",
		menu_valuename_punish_super2 = "Super 2",
		menu_valuename_mash_off = "Off",
		menu_valuename_mash_on = "Light",
		menu_valuename_mash_reversal = "Reversal",
		menu_valuename_mash_super = "Super 1",
		menu_valuename_mash_super2 = "Super 2",
		...
		menu_valuename_dummymode_wjump = "Double Jump", --Ikemen feature
		...
		menu_valuename_buttonjam_a = "Light", --Ikemen feature
		menu_valuename_buttonjam_b = "Medium", --Ikemen feature
		menu_valuename_buttonjam_c = "Heavy", --Ikemen feature
		menu_valuename_buttonjam_x = "Grab", --Ikemen feature
		menu_valuename_buttonjam_y = "Special", --Ikemen feature
		menu_valuename_buttonjam_z = "Remix", --Ikemen feature
...
function motif.setBaseTrainingInfo()
	...
	motif.training_info.menu_itemname_menutraining_punish = "Block Punish"
	motif.training_info.menu_itemname_menutraining_mash = "Mash"
	...
	motif.training_info.menu_itemname_reload = "Reset"
