...
menu.t_valuename = {
	...
	guardmode = {
		...
		{itemname = 'pushblock', displayname = motif.training_info.menu_valuename_guardmode_pushblock},
		{itemname = 'recoil', displayname = motif.training_info.menu_valuename_guardmode_recoil},
		{itemname = 'burst', displayname = motif.training_info.menu_valuename_guardmode_burst},
	...
	fallrecovery = {
		...
		{itemname = 'up', displayname = motif.training_info.menu_valuename_fallrecovery_up}, -- 2 
		{itemname = 'upback', displayname = motif.training_info.menu_valuename_fallrecovery_upback}, -- 1
		{itemname = 'upforward', displayname = motif.training_info.menu_valuename_fallrecovery_upfwd}, -- 2 
	},
	punish = {
		{itemname = 'off', displayname = motif.training_info.menu_valuename_punish_off}, -- 0
		{itemname = 'on', displayname = motif.training_info.menu_valuename_punish_on}, -- 1
		{itemname = 'reversal', displayname = motif.training_info.menu_valuename_punish_reversal}, -- 2
		{itemname = 'super', displayname = motif.training_info.menu_valuename_punish_super}, -- 3
		{itemname = 'super', displayname = motif.training_info.menu_valuename_punish_super2}, -- 3
	},
	mash = {
		{itemname = 'off', displayname = motif.training_info.menu_valuename_mash_off}, -- 0
		{itemname = 'on', displayname = motif.training_info.menu_valuename_mash_on}, -- 1
		{itemname = 'reversal', displayname = motif.training_info.menu_valuename_mash_reversal}, -- 2
		{itemname = 'super', displayname = motif.training_info.menu_valuename_mash_super}, -- 3
		{itemname = 'super', displayname = motif.training_info.menu_valuename_mash_super2}, -- 3
	},
	atkdatadisp = {
...
menu.t_itemname = {
	...
	--mash
	['mash'] = function(t, item, cursorPosY, moveTxt, section)
		if menu.f_valueChanged(t.items[item], motif[section]) then
			charMapSet(2, '_iksys_trainingMash', menu.mash - 1)
		end
		return true
	end,
	--Dummy Mode
...
menu.t_vardisplay = {
	...
	['mash'] = function()
		return menu.t_valuename.mash[menu.mash or 1].displayname
	end,
}
...
function menu.f_trainingReset()
	...
	charMapSet(2, '_iksys_trainingMash', 0)
end
...
function menu.f_commandlistRender(section, t)
	...
	elseif main.f_input(main.t_players, {'$U'}) and t.tbl.movelistLine > 1 then
		sndPlay(motif.files.snd_data, motif[section].cursor_move_snd[1], motif[section].cursor_move_snd[2])
		t.tbl.movelistLine = t.tbl.movelistLine - 24
